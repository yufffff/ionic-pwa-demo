        ...
        return (
            <div class="c-textarea">
                <textarea
                    ...
                    onInput={e => this.textInpiut(e)}
                />
                <div class="c-textarea_number">{this.text.length}/140</div>
                <ion-button class="c-textarea_button" disabled={this.validate} onClick={() => this.send()}>
