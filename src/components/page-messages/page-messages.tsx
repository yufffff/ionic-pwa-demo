                                ...
                                {(() => {
                                    if (this.loginUser && this.messages.length > 0) {
                                        ...
                                        for (const message of this.messages) {
                                            list.push(
                                                <div class="c-messages_item">
                                                    <div class="c-messages_item-created">{formatDate(message.createdAt)}</div>
                                                    <div class="c-messages_item-message">{message.body}</div>
                                                    <div class="c-messages_item-button">
