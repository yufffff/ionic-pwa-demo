            ...
            <ion-content>
                {(() => {
                    if (this.loginUser) {
                        return (
                            <div class="p-setting">
                                <div class="p-setting_title">設定</div>
                                <div class="p-setting_form">
                                    <div class="p=setting_form-label">表示名</div>
                                    <div class="p-setting_form-input">
                                        <ion-input value={this.loginUser.displayName} ref={(el: any) => (this.textInput = el as HTMLInputElement)} />
                                    </div>
                                    <div class="p-setting_save">
                                ...
                                <div class="p-setting_logout">
                                    <ion-button color="medium" size="small" fill="clear" onClick={() => this.logout()}>ログアウトする</ion-button>
                                </div>
                            </div>
                        );
                    }
